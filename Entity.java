...
public abstract class Entity{
 ...
 /** maximum speed for a player for use in tournament */
  ...
  protected void checkCoordinates(Field field) throws EntityOutOfBoundsException{
    if (this.x < field.minX){throw new EntityOutOfBoundsException("Player"+this.id+" out of bounds at X min");}
    else if (this.x > field.maxX-15){throw new EntityOutOfBoundsException("Player"+this.id+" out of bounds at X max");}
    else if (this.y < field.minY){throw new EntityOutOfBoundsException("Player"+this.id+" out of bounds at Y min");}
    else if (this.y > field.maxY-15){throw new EntityOutOfBoundsException("Player"+this.id+" out of bounds at Y max");}
